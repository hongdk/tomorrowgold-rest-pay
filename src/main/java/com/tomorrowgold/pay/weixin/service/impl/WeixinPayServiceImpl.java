...
public class WeixinPayServiceImpl implements IWeixinPayService {
	...
	@Override
	public String scanPay2(PayOrder product) {
		...
		try {
			...
			String totalFee = product.getTotalAmount();
	...
	@Override
	public void scanPay1(PayOrder product) {
	...
	@SuppressWarnings("rawtypes")
	@Override
	public String weixinRefund(PayOrder product) {
	...
	@SuppressWarnings("rawtypes")
	@Override
	public String weixinCloseorder(PayOrder product) {
	...
	@Override
	public String pubAccountPay(PayOrder product) {
		String totalFee = product.getTotalAmount();
	...
	@SuppressWarnings("rawtypes")
	@Override
	public String h5Pay(PayOrder product) {
		...
		try {
			...
			value.put("type", "WAP");
			value.put("wap_url", "https://WAP网站URL地址");////WAP网站URL地址  TODO
			value.put("wap_name", "明日众够");//WAP 网站名
